      ...
      <div className={`ml-40 mr-40`}>
        ...
        <div className="mt-8 flex flex-wrap justify-between">
          <div className="flex flex-wrap gap-8">
            <div>
              <a href="https://www.makemytrip.com/flights/?cmp=SEM|D|DF|G|Brand|Brand-BrandExact_DT|B_M_Makemytrip_Search_Exact|RSA&cmpdata=SEM|MMT|BRAND&gad_source=1&gad_campaignid=313149128&gclid=EAIaIQobChMImeOGpsbRjwMV7qhmAh2RtDsHEAAYASAAEgK7VPD_BwEF">
                <img
